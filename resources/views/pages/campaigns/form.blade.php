            ...
            <div class="card-body p-4">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="title" placeholder="Example: Summer Sale"
                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            <label class="form-label fw-medium mb-0">Banner</label>
                        ...
                        @if ($btn === 'edit' && $data->banner_path)
                            <div class="mb-3">
                                <img src="{{ Storage::url($data->banner_path) }}" class="rounded shadow-sm"
                                    style="max-width: 300px;" id="existingBanner">
                            </div>
                        @endif
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description" rows="4" class="form-control" placeholder="Write discount description here...">{{ old('description', $btn === 'edit' ? $data->description : '') }}</textarea>
