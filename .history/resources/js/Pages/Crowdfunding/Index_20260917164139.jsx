                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6 relative z-10">
                        ...
                        <Link
                            ...
                            className="hidden md:inline-flex items-center gap-2 bg-cream hover:bg-ink text-ink hover:text-cream border-2 border-gold-line hover:border-slate-900 px-6 py-3.5 rounded-xl font-bold text-sm transition-all duration-300 shadow-sm hover:shadow-xl"
                        >
