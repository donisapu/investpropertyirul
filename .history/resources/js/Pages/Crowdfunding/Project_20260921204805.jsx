...
export default function Crowdfunding({ properties, settings }) {
    ...
    return (
        <PublicLayout>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 min-h-screen bg-cream-deep">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                    ...
                    <div className="relative w-full md:w-[380px] group">
                        <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none text-ink-soft group-focus-within:text-gold-ink transition-colors">
                        ...
                        <input
                            ...
                            className="w-full pl-12 pr-4 py-4 bg-cream border border-gold-line rounded-2xl text-sm text-ink placeholder-ink-soft outline-none transition-all duration-300 shadow-sm focus:shadow-[0_8px_30px_rgba(199,164,92,0.15)] focus:border-gold focus:ring-0"
                        />
                        ...
                        <div className="absolute inset-y-0 right-4 flex items-center pointer-events-none opacity-0 group-focus-within:opacity-100 transition-opacity duration-300">
                            <span className="text-[10px] font-bold text-ink-soft uppercase tracking-widest bg-cream-sink px-2 py-1 rounded-md">
                                Ketik
                            </span>
                        </div>
                    </div>
                ...
                {filteredProperties.length > 0 ? (
                    <div>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 xl:gap-10">
                            {filteredProperties.map((prop, index) => (
                                <div
                                    key={index}
                                    className="bg-cream rounded-[2rem] shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_60px_rgba(199,164,92,0.2)] border border-gold-line overflow-hidden flex flex-col transition-all duration-500 hover:-translate-y-1.5 group"
                                >
                                    {/* Image Section */}
                                    <div className="relative h-56 bg-cream-sink overflow-hidden">
                                        ...
                                        />
                                        <div className="absolute inset-0 bg-gradient-to-t from-ink/60 via-transparent to-transparent opacity-60 group-hover:opacity-80 transition-opacity duration-500"></div>
                                    ...
                                    <div className="p-6 md:p-8 flex-1 flex flex-col relative bg-cream">
                                        ...
                                        <p className="text-sm font-medium text-ink-soft mb-6 flex items-center gap-1.5">
                                            <MapPin
                                                size={14}
                                        ...
                                        {/* Info Grid 4 Kotak */}
                                        <div className="grid grid-cols-2 gap-3 bg-cream-sink/80 p-4 rounded-2xl mb-8 border border-gold-line">
                                            <div>
                                        ...
                                        <Link
                                            ...
                                            className={`px-5 py-2.5 text-xs font-bold rounded-full transition-all duration-300 ${
                                                link.active
                                                    ...
                                                    : "bg-cream text-ink-soft border border-gold-line hover:bg-cream-sink hover:border-gold hover:text-ink"
                                            } ${!link.url ? "opacity-40 cursor-not-allowed hover:bg-cream hover:border-gold-line" : ""}`}
                                        />
                                    );
                                })}
                            </div>
                    ...
                    <div className="text-center bg-cream rounded-3xl border-2 border-dashed border-gold-line py-24 px-4 text-ink-soft text-sm shadow-sm max-w-2xl mx-auto flex flex-col items-center">
                        <div className="w-16 h-16 bg-cream-sink rounded-full flex items-center justify-center mb-4">
                            <Search className="w-8 h-8 text-ink-soft/50" />
                        </div>
                        <span className="font-bold text-ink text-lg mb-2">
