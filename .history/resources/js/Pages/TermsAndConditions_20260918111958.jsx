...
export default function TermsAndConditions({ auth, settings }) {
    const sections = [
        {
            id: "definisi",
            icon: <Building2 className="w-6 h-6 text-gold-ink" />,
        ...
        {
            id: "kyc",
            icon: <ShieldCheck className="w-6 h-6 text-gold-ink" />,
        ...
        {
            id: "produk",
            icon: <Coins className="w-6 h-6 text-gold-ink" />,
        ...
        {
            id: "risiko",
            icon: <AlertTriangle className="w-6 h-6 text-gold-ink" />,
        ...
        {
            id: "hukum",
            icon: <Scale className="w-6 h-6 text-gold-ink" />,
