...
export default function Show({ property , settings}) {
    ...
    return (
        <PublicLayout>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="mb-8 w-full h-[400px] md:h-[480px] rounded-2xl overflow-hidden shadow-md bg-cream">
                            {/* LAYOUT: 1 GAMBAR */}
                                                ...
                                                >
                                                    ...
                                                    {idx === 3 &&
                                                        displayImages.length >
                                                            5 && (
                                                            <div className="absolute inset-0 bg-ink/40 hover:bg-ink/50 transition-colors flex flex-col items-center justify-center text-cream backdrop-blur-[2px]">
                        ...
                        <div className="bg-white rounded-3xl p-6 md:p-8 shadow-[0_2px_10px_-3px_rgba(0,0,0,0.05)] border border-cream mb-8">
                            <div className="flex flex-col md:flex-row md:items-start justify-between gap-5">
                                ...
                                <div className="flex-1">
                                        ...
                                        <span
                                            className={`inline-flex items-center px-3 py-1 rounded-full text-[11px] font-bold uppercase tracking-wider ${
                                                property.sold
                                                    ...
                                                    : "bg-gold-line text-gold-ink ring-1 ring-gold/20"
                                            }`}
                                        >
                                            <span
                                    ...
                                    <h1 className="text-3xl md:text-4xl font-extrabold text-ink tracking-tight mb-2.5">
                                        {property.name}
                                    </h1>
                                ...
                                {property.listing_url && (
                                    <div className="mt-2 md:mt-0 flex-none">
                                        <a
                                            ...
                                            className="inline-flex items-center justify-center gap-2 bg-white border border-gold-line text-ink hover:text-gold-ink hover:border-gold hover:bg-gold-line hover:shadow-sm font-bold px-5 py-3 rounded-xl text-sm transition-all w-full md:w-auto"
                                        >
                        ...
                        {/* Stats Bar */}
                        <div className="bg-white rounded-3xl p-6 md:p-8 shadow-[0_2px_10px_-3px_rgba(0,0,0,0.05)] border border-cream mb-8">
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-y-8 md:gap-y-0 md:divide-x divide-cream">
                                {/* BEDROOMS */}
                                <div className="flex flex-col items-center justify-center text-center px-4 group">
                                    ...
                                    <div className="w-14 h-14 bg-gold-line rounded-2xl flex items-center justify-center mb-3 text-gold-ink group-hover:scale-110 group-hover:bg-gold-line transition-all duration-300">
                                    ...
                                    <div className="text-[10px] font-bold text-ink-soft uppercase tracking-widest mt-1">
                                        Bedrooms
                                    </div>
                                </div>
                        ...
                        <div className="bg-white rounded-3xl p-6 md:p-8 shadow-[0_2px_10px_-3px_rgba(0,0,0,0.05)] border border-cream mb-8">
                            ...
                            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-8 pb-6 border-b border-cream">
                                <div>
                                    <h3 className="text-xl font-extrabold text-ink flex items-center gap-2 mb-1.5">
                                        <TrendingUp className="w-5 h-5 text-gold-ink" />
                                ...
                                <div className="bg-gold-line/70 border border-gold-line rounded-2xl p-4 flex items-center gap-4 min-w-[240px]">
                                    <div className="w-10 h-10 bg-gold text-ink rounded-xl flex items-center justify-center font-bold text-lg shadow-sm shadow-gold/20">
                                        Rp
                                    </div>
                                    <div>
                                        <span className="text-[10px] text-ink/50 font-bold uppercase tracking-wider block">
                                            Total Hasil (5 Tahun)
                                        </span>
                                        <span className="text-lg font-black text-gold-ink">
                            ...
                            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 items-center">
                                ...
                                <div className="space-y-6">
                                    <div>
                                        <label className="text-xs font-bold text-ink-soft uppercase tracking-widest block mb-2">
                                            Jumlah Investasi
                                        </label>
                                        ...
                                        <input
                                            ...
                                            className="w-full h-2 bg-cream rounded-lg appearance-none cursor-pointer accent-gold-ink"
                                        />
                                        <div className="flex justify-between text-[10px] text-ink-soft font-bold mt-2">
                                    ...
                                    <div className="bg-cream-sink rounded-xl p-4 border border-cream">
                        ...
                        {/* Content Tabs */}
                        <div className="bg-white rounded-3xl shadow-[0_2px_10px_-3px_rgba(0,0,0,0.05)] border border-cream overflow-hidden mb-8">
                            {/* Navigasi Tab - Dibuat scrollable halus di HP (scrollbar-none) */}
                            <div className="border-b border-cream bg-cream-sink/50 px-2 md:px-6">
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`flex items-center gap-2 px-5 py-2.5 text-sm font-bold rounded-xl whitespace-nowrap transition-all duration-200 ${
                                                    isActive
                                                        ? "bg-gold-ink text-cream shadow-md shadow-gold-ink/20"
                                ...
                                {activeTab === "details" && (
                                    <div className="space-y-8 animate-in fade-in duration-300">
                                        <div>
                                            ...
                                            <div className="prose prose-slate max-w-none text-ink-soft text-sm leading-relaxed whitespace-pre-line">
                                                {property.detail}
                                            </div>
                                        </div>
                                        ...
                                        {property.map_url && (
                                            <div>
                                                <h3 className="text-lg font-extrabold text-ink mb-3 flex items-center gap-2">
                                                    <MapPin className="w-5 h-5 text-gold-ink" />
                                                    Lokasi & Sekitar
                                                </h3>
                                                <div className="aspect-video w-full rounded-2xl overflow-hidden bg-cream border border-cream shadow-inner">
                                                    {finalMapUrl ? (
                                                        <iframe
                                                            src={finalMapUrl}
                                                            width="100%"
                                    ...
                                    <div className="space-y-8 animate-in fade-in duration-300">
                                        ...
                                        <div>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                ...
                                                <div className="p-5 border border-cream bg-cream-sink/60 rounded-2xl shadow-sm hover:border-gold hover:bg-gold-line/30 transition-all duration-300 group">
                                                    <div className="text-[10px] font-bold text-ink-soft uppercase tracking-widest mb-1.5 group-hover:text-gold-ink transition-colors">
                                                        Annual Rental Yield
                                                    </div>
                                                ...
                                                <div className="p-5 border border-cream bg-cream-sink/60 rounded-2xl shadow-sm hover:border-gold hover:bg-gold-line/20 transition-all duration-300 group">
                                                    <div className="text-[10px] font-bold text-ink-soft uppercase tracking-widest mb-1.5 group-hover:text-gold-ink transition-colors">
                                        ...
                                        <div>
                                            <h3 className="text-base font-extrabold text-ink mb-4 flex items-center gap-2">
                                                <span className="w-1.5 h-5 bg-ink-soft rounded-full"></span>
                                                Rincian Nilai Aset Properti
                                                (Asset Breakdown)
                                            </h3>

                                            <div className="bg-white rounded-2xl border border-cream overflow-hidden shadow-sm divide-y divide-cream">
                                                {/* Row Utama Total Pendanaan */}
                                                <div className="flex justify-between items-center p-4 bg-gold-line/40">
                                                ...
                                                {[
                                                    ...
                                                    <div
                                                        key={idx}
                                                        className="flex justify-between items-center p-4 text-sm hover:bg-cream-sink/50 transition-colors"
                                                    >
                                                ...
                                                {property.documents.map(
                                                    (doc, idx) => (
                                                        <a
                                                            ...
                                                            target="_blank"
                                                            rel="noopener noreferrer"
                                                            className="flex items-center justify-between p-4 bg-cream-sink border border-cream rounded-2xl hover:border-gold hover:bg-gold-line/50 transition-all group shadow-sm"
                                                        >
                                                            <div className="flex items-center gap-3.5 min-w-0">
                                                                <div className="w-11 h-11 bg-white rounded-xl flex items-center justify-center text-ink-soft border border-cream group-hover:text-gold-ink group-hover:border-gold-line transition-colors flex-none shadow-sm">
                                                                    <FileText className="w-5 h-5" />
                                                                </div>
                                                                <div className="min-w-0">
                                                                    <div className="font-bold text-ink text-sm group-hover:text-ink truncate">
                                                                        {doc.name ||
                                                                            `Dokumen Legalitas ${idx + 1}`}
                                                                    </div>
                                                                    <div className="text-[11px] font-bold text-ink-soft uppercase tracking-wide mt-0.5">
                                                                        Klik
                                                                        untuk
                                                                        Unduh
                                                                        PDF
                                                            ...
                                                            <Download className="w-5 h-5 text-ink-soft group-hover:text-gold-ink group-hover:translate-y-0.5 transition-all flex-none mr-1" />
                                                        </a>
                                                    ),
                                                )}
                                            </div>
                                        ) : (
                                            <div className="text-center py-12 bg-cream-sink rounded-2xl border border-cream text-ink-soft">
                                                <FileText className="w-12 h-12 mx-auto mb-3 text-gold-line" />
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <div className="bg-white rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-cream sticky top-24">
                            {/* BAGIAN 1: URGENCY & PROGRESS */}
                            <div className="mb-6">
                                <div className="flex justify-between items-end mb-2.5">
                                    <div>
                                        <span className="text-[10px] font-bold text-ink-soft uppercase tracking-widest block mb-0.5">
                                            Terkumpul
                                        </span>
                                        <span className="text-xl font-black text-gold-ink">
                                ...
                                <div className="w-full bg-cream rounded-full h-3 overflow-hidden shadow-inner">
                                    <div
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-8">
                                <div className="p-3.5 rounded-2xl bg-gold-line/50 border border-gold-line/50 flex flex-col items-center justify-center text-center">
                                    <div className="text-[10px] text-ink/60 font-bold uppercase tracking-wider flex items-center gap-1 mb-1">
                                        Est. ROI{" "}
                                        <Info className="w-3 h-3 text-gold-ink/50" />
                                    </div>
                                    <div className="text-2xl font-black text-gold-ink">
                                        {property.financials.irr}
                                    </div>
                                </div>
                                <div className="p-3.5 rounded-2xl bg-cream-sink border border-cream flex flex-col items-center justify-center text-center">
                                    <div className="text-[10px] text-ink-soft font-bold uppercase tracking-wider flex items-center gap-1 mb-1">
                                        Periode{" "}
                                        <Info className="w-3 h-3 text-ink-soft" />
                                    </div>
                            ...
                            <div className="space-y-3">
                                ...
                                {auth.user ? (
                                    ...
                                    >
                                        <Link
                                            ...
                                            className={`w-full py-4 rounded-xl font-bold text-cream text-sm transition-all flex items-center justify-center gap-2 ${
                                                property.sold
                                                    ? "bg-gold-line text-ink-soft cursor-not-allowed"
                                                    : "bg-gold-ink hover:bg-gold-ink/90 shadow-[0_8px_20px_-6px_rgba(199,164,92,0.4)] hover:-translate-y-0.5"
                                            }`}
                                        >
                                            {property.sold
                                                ? "Pendanaan Ditutup"
                                        ...
                                        <Link
                                            ...
                                            className="w-full py-4 rounded-xl font-bold text-ink bg-white border-2 border-gold-line hover:border-gold-line hover:bg-cream-sink text-sm text-center block transition-all"
                                        >
                                            Jual Lot
                                        </Link>
                                    </div>
                                    ...
                                    <a
                                        ...
                                        className={`w-full py-4 rounded-xl font-bold text-cream text-sm transition-all flex items-center justify-center gap-2 ${
                                            property.sold
                                                ? "bg-gold-line text-ink-soft cursor-not-allowed"
                                                : "bg-ink hover:bg-gold-ink shadow-md hover:shadow-gold/25"
                                        }`}
                                    >
                                        {property.sold
                                            ? "Pendanaan Ditutup"
                                ...
                                <div className="pt-4 mt-4 border-t border-cream flex items-center justify-center gap-2 text-xs font-medium text-ink-soft">
                                    <svg
            ...
            {lightboxOpen && (
                <div
                    className="fixed inset-0 z-[100] bg-ink/90 flex items-center justify-center p-4 backdrop-blur-sm"
                    onClick={closeLightbox}
                >
                    {/* Close Button */}
                    <button
                        onClick={closeLightbox}
                        className="absolute top-4 right-4 text-cream/70 hover:text-cream transition-colors p-2 z-50"
                    >
                        <X size={32} />
                    </button>
                    ...
                    <button
                        onClick={prevImage}
                        className="absolute left-4 text-cream/70 hover:text-cream transition-colors p-2 hover:bg-cream/10 rounded-full z-50"
                    >
                        <ChevronLeft size={48} />
                    </button>
                    ...
                    <button
                        onClick={nextImage}
                        className="absolute right-4 text-cream/70 hover:text-cream transition-colors p-2 hover:bg-cream/10 rounded-full z-50"
                    >
                    ...
                    >
                        ...
                        {/* Counter */}
                        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-ink/50 text-cream px-4 py-2 rounded-full backdrop-blur-md text-sm font-medium">
