                                    ...
                                    >
                                        ...
                                        <div className="p-6 md:p-8 flex-1 flex flex-col relative bg-white">
                                            ...
                                            <Link
                                                ...
                                                className="mt-auto w-full text-center bg-white border-2 border-gold-line text-slate-700 hover:border-[#24608B] hover:bg-[#24608B] hover:text-cream font-bold py-4 rounded-xl transition-all duration-300 text-sm shadow-sm hover:shadow-lg hover:-translate-y-0.5"
                                            >
                                                Lihat Prospektus
                                            </Link>
                                        </div>
