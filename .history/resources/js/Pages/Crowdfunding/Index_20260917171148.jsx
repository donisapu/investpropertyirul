            ...
            >
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {properties.data.length > 0 ? (
                        ...
                        <div className="text-center bg-cream-sink/50 rounded-3xl border-2 border-dashed border-slate-200 py-24 px-4 text-ink-soft text-sm max-w-3xl mx-auto flex flex-col items-center">
                            <Building2
                                size={48}
