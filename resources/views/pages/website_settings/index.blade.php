...
@section('content')
    <div class="card shadow-sm border-0">
        ...
        <form id="websiteSettingForm" action="{{ route('admin.website-settings.update') }}" method="POST"
            ...
            <div class="card-body p-4">
                <div class="row g-4">
                    ...
                    <div class="col-md-12">
                        ...
                        <div id="dropzone" class="border rounded-3 p-3 text-center position-relative"
                            ...
                            <img id="logoPreview" src="{{ $setting->logo_url }}" class="img-fluid rounded mb-2"
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="address" name="address" rows="2" class="form-control">{{ old('address', $setting->address) }}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" id="whatsapp" name="whatsapp" class="form-control" placeholder="628123xxxx"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="url" name="youtube_video_url" id="youtubeInput" class="form-control"
