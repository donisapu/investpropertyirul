        ...
        <footer className="bg-white text-slate-900">
            <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="mt-6 relative">
                    {canScroll && !atStart && (
                        <button type="button" onClick={() => scroll(-300)} className="absolute left-0 top-1/2 -translate-y-1/2 h-8 w-8 rounded-full bg-white shadow border border-slate-200 text-slate-700 hover:bg-slate-50">‹</button>
                    )}
                    <div ref={rowRef} className="overflow-x-auto flex items-center justify-center whitespace-nowrap scrollbar-hide px-10">
                    ...
                    {canScroll && !atEnd && (
                        <button type="button" onClick={() => scroll(300)} className="absolute right-0 top-1/2 -translate-y-1/2 h-8 w-8 rounded-full bg-white shadow border border-slate-200 text-slate-700 hover:bg-slate-50">›</button>
                    )}
                </div>
