    ...
    return (
        <PublicLayout>
            ...
            <div className="relative overflow-hidden bg-white border-b border-gold-line">
                ...
                <div className="absolute bottom-0 left-10 w-[300px] h-[300px] bg-gold-100 rounded-full blur-[100px] opacity-20 -z-10"></div>
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 z-10">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
                        ...
                        <div className="flex-1 text-center lg:text-left space-y-8">
                            ...
                            <div>
                                <span className="inline-flex items-center gap-2 bg-cream-sink text-slate-700 text-xs font-bold px-3.5 py-2 rounded-full border border-gold-line/60 shadow-sm">
                                    <Sparkles
                                        size={12}
                            ...
                            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-ink leading-[1.1] tracking-tight">
                                Sekarang Semua Bisa{" "}
                                <br className="hidden md:block" />
                                <span className="bg-gradient-to-r from-gold-ink via-gold to-gold-ink bg-clip-text text-transparent">
                                    Patungan Properti
                                </span>
                            </h1>
                            ...
                            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
                                {topCrowdfundingId ? (
                                    ...
                                    <button
                                        disabled
                                        className="bg-gray-400 text-cream px-8 py-4 rounded-xl font-bold text-sm cursor-not-allowed"
                                    >
                                ...
                                <a
                                    href="#projects"
                                    className="inline-flex items-center justify-center gap-2 bg-white hover:bg-cream-sink text-slate-700 border-2 border-gold-line/80 px-6 py-4 rounded-xl font-bold text-sm transition-all"
                                >
                                    Lihat Project Aktif{" "}
                        ...
                        <div className="flex-1 relative flex justify-center items-center w-full max-w-lg lg:max-w-none">
                            ...
                            <div className="relative w-full max-w-md p-4">
                                ...
                                <div className="absolute -bottom-2 -left-4 bg-white/95 backdrop-blur-md p-4 rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.06)] border border-gold-line flex items-center gap-3.5 transition-all duration-300 hover:-translate-y-1">
                                    <div className="w-11 h-11 bg-emerald-50 rounded-xl flex items-center justify-center text-gold-ink border border-emerald-100/50 flex-none shadow-sm">
                                        <Banknote size={20} />
                                    </div>
                                ...
                                <div className="absolute -top-4 -right-4 bg-white/95 backdrop-blur-md p-4 rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.06)] border border-gold-line flex items-center gap-3.5 transition-all duration-300 hover:-translate-y-1">
                                    <div className="w-11 h-11 bg-blue-50 rounded-xl flex items-center justify-center text-gold-ink border border-blue-100/50 flex-none shadow-sm">
                                        <Percent size={18} />
                                    </div>
                                    <div className="min-w-0">
                                        <div className="text-[9px] text-slate-400 font-bold uppercase tracking-widest block">
            ...
            <div className="relative bg-cream-sink/50 py-24 border-b border-gold-line overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div className="text-center max-w-2xl mx-auto mb-16 md:mb-20">
                        <span className="inline-flex items-center gap-1.5 text-gold-ink font-bold uppercase tracking-widest text-[10px] bg-blue-100/50 px-3 py-1.5 rounded-full mb-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 xl:gap-8">
                        {/* CARD 1: Mudah */}
                        <div className="bg-white rounded-[2rem] p-8 border border-gold-line/60 hover:border-blue-200 shadow-sm hover:shadow-[0_8px_30px_rgb(36,96,139,0.06)] transition-all duration-500 group relative overflow-hidden text-left">
                            ...
                            <div className="relative z-10 w-14 h-14 bg-cream-sink border border-gold-line rounded-2xl flex items-center justify-center mb-6 group-hover:bg-ink group-hover:scale-110 group-hover:-rotate-3 transition-all duration-500 shadow-sm">
                                <MonitorCheck className="w-6 h-6 text-slate-700 group-hover:text-cream transition-colors duration-500" />
                            </div>
                        ...
                        <div className="bg-white rounded-[2rem] p-8 border border-gold-line/60 hover:border-blue-200 shadow-sm hover:shadow-[0_8px_30px_rgb(36,96,139,0.06)] transition-all duration-500 group relative overflow-hidden text-left">
                            ...
                            <div className="relative z-10 w-14 h-14 bg-cream-sink border border-gold-line rounded-2xl flex items-center justify-center mb-6 group-hover:bg-gold group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 shadow-sm">
                                <Settings2 className="w-6 h-6 text-slate-700 group-hover:text-cream transition-colors duration-500" />
                            </div>
                        ...
                        <div className="bg-white rounded-[2rem] p-8 border border-gold-line/60 hover:border-blue-200 shadow-sm hover:shadow-[0_8px_30px_rgb(36,96,139,0.06)] transition-all duration-500 group relative overflow-hidden text-left">
                            ...
                            <div className="relative z-10 w-14 h-14 bg-cream-sink border border-gold-line rounded-2xl flex items-center justify-center mb-6 group-hover:bg-indigo-600 group-hover:scale-110 group-hover:-rotate-3 transition-all duration-500 shadow-sm">
                                <SearchCheck className="w-6 h-6 text-slate-700 group-hover:text-cream transition-colors duration-500" />
                            </div>
                        ...
                        <div className="bg-white rounded-[2rem] p-8 border border-gold-line/60 hover:border-blue-200 shadow-sm hover:shadow-[0_8px_30px_rgb(36,96,139,0.06)] transition-all duration-500 group relative overflow-hidden text-left">
                            ...
                            <div className="relative z-10 w-14 h-14 bg-cream-sink border border-gold-line rounded-2xl flex items-center justify-center mb-6 group-hover:bg-amber-500 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 shadow-sm">
                                <LayoutGrid className="w-6 h-6 text-slate-700 group-hover:text-cream transition-colors duration-500" />
                            </div>
            ...
            <div className="py-24 bg-white relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    ...
                    <div className="max-w-2xl mx-auto mb-20">
                        <span className="inline-flex items-center gap-1.5 text-gold-ink font-bold uppercase tracking-widest text-[10px] bg-blue-50 px-3 py-1.5 rounded-full mb-4 border border-blue-100">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 lg:gap-8 relative z-10">
                            ...
                            <div className="relative flex flex-col items-center text-center group">
                                ...
                                <div className="w-36 h-36 relative z-10 flex items-center justify-center mb-8">
                                    ...
                                    <div className="absolute inset-0 bg-cream-sink rounded-[2.5rem] rotate-45 group-hover:rotate-90 group-hover:bg-blue-50 transition-all duration-700 ease-in-out border border-gold-line shadow-sm"></div>
                                    ...
                                    <div className="absolute -top-1 -right-1 w-10 h-10 bg-slate-900 text-cream font-black text-sm rounded-xl flex items-center justify-center shadow-lg transform rotate-6 group-hover:rotate-12 group-hover:scale-110 transition-all duration-300 border-2 border-white">
                                        01
                                    </div>
                                </div>
                            ...
                            <div className="relative flex flex-col items-center text-center group">
                                ...
                                <div className="w-36 h-36 relative z-10 flex items-center justify-center mb-8">
                                    <div className="absolute inset-0 bg-cream-sink rounded-[2.5rem] rotate-45 group-hover:rotate-90 group-hover:bg-emerald-50 transition-all duration-700 ease-in-out border border-gold-line shadow-sm"></div>
                                    <div className="absolute inset-2 bg-white rounded-full shadow-[0_8px_30px_rgb(0,0,0,0.06)] flex items-center justify-center group-hover:-translate-y-2 transition-transform duration-500">
                                        <img
                            ...
                            <div className="relative flex flex-col items-center text-center group">
                                ...
                                <div className="w-36 h-36 relative z-10 flex items-center justify-center mb-8">
                                    <div className="absolute inset-0 bg-cream-sink rounded-[2.5rem] rotate-45 group-hover:rotate-90 group-hover:bg-indigo-50 transition-all duration-700 ease-in-out border border-gold-line shadow-sm"></div>
                                    <div className="absolute inset-2 bg-white rounded-full shadow-[0_8px_30px_rgb(0,0,0,0.06)] flex items-center justify-center group-hover:-translate-y-2 transition-transform duration-500">
                                        <img
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6 relative z-10">
                        ...
                        <Link
                            ...
                            className="hidden md:inline-flex items-center gap-2 bg-cream hover:bg-ink text-ink hover:text-cream border-2 border-gold-line hover:border-ink px-6 py-3.5 rounded-xl font-bold text-sm transition-all duration-300 shadow-sm hover:shadow-xl"
                        >
                    ...
                    {properties.data.length > 0 ? (
                        ...
                        <div className="relative w-full -mx-4 px-4 sm:mx-0 sm:px-0">
                            ...
                            >
                                {properties.data.map((prop, index) => (
                                    <SwiperSlide
                                        key={index}
                                        className="!w-[320px] md:!w-[380px] bg-white rounded-[2rem] shadow-[0_10px_40px_rgba(0,0,0,0.06)] border border-gold-line overflow-hidden flex flex-col transition-all duration-500 hover:shadow-[0_20px_60px_rgba(36,96,139,0.15)] group"
                                    >
                                        {/* Image Section Keren */}
                                        ...
                                        <div className="p-6 md:p-8 flex-1 flex flex-col relative bg-white">
                                            ...
                                            <Link
                                                ...
                                                className="mt-auto w-full text-center bg-white border-2 border-gold-line text-slate-700 hover:border-[#6B4F21] hover:bg-[#6B4F21] hover:text-cream font-bold py-4 rounded-xl transition-all duration-300 text-sm shadow-sm hover:shadow-lg hover:-translate-y-0.5"
                                            >
                                                Lihat Prospektus
                                            </Link>
                                        </div>
                            ...
                            <div className="mt-8 flex justify-center md:hidden relative z-10">
                                <Link
                                    href={route("crowdfunding.project")}
                                    className="w-full bg-ink hover:bg-ink-soft text-cream px-8 py-4 rounded-xl font-bold text-sm text-center transition-all shadow-md"
                                >
                                    Lihat Semua Proyek
                                </Link>
                            </div>
                        ...
                        <div className="text-center bg-cream-sink/50 rounded-3xl border-2 border-dashed border-gold-line 0 py-24 px-4 text-ink-soft text-sm max-w-3xl mx-auto flex flex-col items-center">
                            <Building2
                                size={48}
