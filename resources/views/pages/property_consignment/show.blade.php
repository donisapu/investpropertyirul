                ...
                <div class="col-12">
                    <table class="table">
                        ...
                        <tr>
                            <th>Listing Type</th>
                            <th>:</th>
                            <th>{{ $data->listing_type }}</th>
                        </tr>
                        @if ($data->listing_type == 'Leasehold')
                            <tr>
                                <th>Lease Term</th>
                                <th>:</th>
                                <th>{{ $data->lease_term }}</th>
                            </tr>
                        @endif
                        <tr>
                            <th>Status</th>
                    ...
                    <a href="{{ route('admin.consignment-properties') }}" class="btn btn-secondary mt-2">Back</a>
                </div>
            </div>
        </div>
    </div>
