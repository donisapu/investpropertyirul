        ...
        <PublicLayout>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="group relative mb-12 overflow-hidden rounded-2xl border border-white/10 bg-[#1b1916] shadow-xl">
                    ...
                    {/* Warm Overlay */}
                    <div className="absolute inset-0 bg-gradient-to-r from-[#ffffff]/10 via-[#1c1a16]/90 to-[#211f1b]/55" />
                ...
                {properties.data.length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {properties.data.map((prop, index) => (
                            <div
                                key={index}
                                className="bg-cream rounded-2xl shadow-sm border border-gold-line overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col group"
                            >
                                {/* Image Section - Ditambah tingginya (h-60) biar visual properti dominan */}
                                <div className="relative h-60 bg-cream-deep overflow-hidden flex-none">
                                    <img
                                        src={
                                            prop.image ||
                                    ...
                                    {/* Badge Lokasi */}
                                    <div className="absolute top-3 right-3 bg-cream/95 backdrop-blur-md px-2.5 py-1 rounded-full text-[11px] font-bold text-ink flex items-center gap-1 shadow-sm">
                                    ...
                                    {/* Badge Sold Out */}
                                    {prop.sold && (
                                        <div className="absolute inset-0 bg-ink/60 backdrop-blur-sm flex items-center justify-center z-10">
                                ...
                                <div className="p-4 flex-1 flex flex-col justify-between">
                                    ...
                                    <div className="mb-3">
                                        <h3 className="text-lg font-bold text-ink mb-1 line-clamp-1 group-hover:text-gold-ink transition-colors">
                                            {prop.name}
                                        </h3>
                                        ...
                                        <div className="flex items-center gap-2 text-xs font-medium text-ink-soft">
                                            <span className="flex items-center gap-1">
                                                <Bed className="w-3.5 h-3.5 text-gold-ink" />{" "}
                                                {prop.specs.bedroom}
                                            </span>
                                            ...
                                            <span className="flex items-center gap-1">
                                                <Bath className="w-3.5 h-3.5 text-gold-ink" />{" "}
                                                {prop.specs.bathroom}
                                            </span>
                                            <span className="text-ink-soft/40">
                                                •
                                            ...
                                            <span className="flex items-center gap-1">
                                                <Maximize className="w-3.5 h-3.5 text-gold-ink" />{" "}
                                                {prop.specs.area}
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-3 border-t border-gold-line pt-3 mb-4 mt-auto">
                                        {/* Kolom Kiri: ROI & Periode */}
                                        <div className="flex flex-col justify-center">
                                            <div className="flex items-baseline gap-1">
                                                <span className="text-xl font-black text-gold-ink tracking-tight">
                                                    {prop.roi}
                                                </span>
                                                <span className="text-[9px] text-ink-soft font-bold uppercase tracking-wider">
                                                    ROI
                                                </span>
                                            </div>
                                        ...
                                        <div className="border-l border-gold-line pl-3 flex flex-col justify-center space-y-1">
                                    ...
                                    <Link
                                        ...
                                        className={`w-full block text-center font-bold text-xs py-2.5 rounded-lg transition-all duration-200 ${
                                            prop.sold
                                                ...
                                                : "bg-ink hover:bg-ink-soft text-cream shadow-sm"
                                        }`}
                                    >
                    ...
                    <div className="text-center py-16 px-4">
                        <div className="bg-cream-deep rounded-2xl p-8 max-w-lg mx-auto border border-gold-line">
                            ...
                            <a
                                href="/"
                                className="inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-ink bg-gold hover:bg-gold/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gold"
                            >
                                Return Home
                            </a>
                        </div>
                ...
                <div className="mt-14 mb-8 flex justify-center items-center gap-2.5">
                    {properties.links.map((link, index) => {
                        ...
                        return link.url ? (
                            <Link
                                ...
                                className={`min-w-[2.75rem] h-11 px-3 flex items-center justify-center rounded-xl text-sm font-bold transition-all duration-200 ${
                                    link.active
                                        ...
                                        : "bg-cream border border-gold-line text-ink-soft hover:border-gold hover:text-gold-ink hover:bg-gold-line hover:-translate-y-0.5"
                                }`}
                            >
                                {content}
                            </Link>
                            ...
                            <span
                                key={index}
                                className="min-w-[2.75rem] h-11 px-3 flex items-center justify-center rounded-xl text-sm font-bold bg-cream-deep border border-gold-line text-ink-soft/50 cursor-not-allowed"
                            >
                                {content}
                            </span>
                        );
