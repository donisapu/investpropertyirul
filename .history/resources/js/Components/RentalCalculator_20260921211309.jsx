...
export default function RentalCalculator() {
    ...
    return (
        <div className="bg-white rounded-3xl p-8 border border-gold-line shadow-xl shadow-cream/50 mt-16 max-w-4xl mx-auto">
            <h3 className="text-2xl font-black text-ink mb-8 text-center">
                Simulasi Cuan
            </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                {/* Bagian Hasil */}
                <div className="bg-ink rounded-2xl p-6 text-cream flex flex-col justify-between">
                    <div>
                        <p className="text-cream/70 text-xs uppercase font-bold tracking-widest mb-1">
                            Net Monthly Income
                        </p>
                        <h4 className="text-3xl font-black text-gold">
                            {netMonthly < 0 ? "-" : ""}
            ...
            <p className="text-[10px] text-ink-soft mt-6 text-center italic">
