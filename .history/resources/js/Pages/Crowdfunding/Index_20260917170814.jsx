                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 xl:gap-8">
                        ...
                        <div className="bg-white rounded-[2rem] p-8 border border-slate-200/60 hover:border-blue-200 shadow-sm hover:shadow-[0_8px_30px_rgb(36,96,139,0.06)] transition-all duration-500 group relative overflow-hidden text-left">
                            ...
                            {/* Icon Container */}
                            <div className="relative z-10 w-14 h-14 bg-cream-sink border border-slate-100 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-ink group-hover:scale-110 group-hover:-rotate-3 transition-all duration-500 shadow-sm">
                        ...
                        <div className="bg-white rounded-[2rem] p-8 border border-slate-200/60 hover:border-blue-200 shadow-sm hover:shadow-[0_8px_30px_rgb(36,96,139,0.06)] transition-all duration-500 group relative overflow-hidden text-left">
                            ...
                            <div className="relative z-10 w-14 h-14 bg-cream-sink border border-slate-100 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-gold group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 shadow-sm">
