...
export default function HowToInvest({ auth }) {
    const steps = [
        {
            icon: <Search className="w-8 h-8 text-gold-ink" />,
        ...
        {
            icon: <FileText className="w-8 h-8 text-gold-ink" />,
        ...
        {
            icon: <Wallet className="w-8 h-8 text-gold-ink" />,
        ...
        {
            icon: <TrendingUp className="w-8 h-8 text-gold-ink" />,
    ...
    const methods = [
        {
            ...
            icon: <Building2 className="w-12 h-12 text-gold-ink mb-4" />,
            description:
        ...
        },
        {
            ...
            icon: <Users className="w-12 h-12 text-gold-ink mb-4" />,
            description:
        ...
        {
            title: "Lelang & Cessie",
            icon: <Gavel className="w-12 h-12 text-gold-ink mb-4" />,
            description:
    ...
    return (
        <PublicLayout auth={auth}>
            ...
            {/* Hero Section */}
            <div className="bg-ink text-cream pt-24 pb-16 px-4">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <p className="text-xl text-cream/75 max-w-2xl mx-auto mb-10">
                    ...
                    {!auth.user && (
                        <Link
                            href={route("register")}
                            className="inline-flex items-center px-8 py-3 bg-gold hover:bg-gold/90 text-ink font-bold rounded-full transition-colors"
                        >
                            Create Free Account
            ...
            {/* Investment Methods */}
            <div className="py-20 bg-cream-deep px-4">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
                        {methods.map((method, index) => (
                            <div
                                key={index}
                                className="bg-cream rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow"
                            >
                                <div className="p-3 rounded-xl inline-block bg-cream-deep mb-6">
                                    {method.icon}
                                </div>
                                ...
                                <ul className="space-y-3 mb-8">
                                    {method.features.map((feature, idx) => (
                                        ...
                                        >
                                            <CheckCircle2 className="w-5 h-5 text-gold-ink mr-3" />
                                            {feature}
                                        </li>
                                    ))}
                                </ul>
                                <Link
                                    href={method.link}
                                    className="block w-full text-center py-3 rounded-xl font-semibold border border-gold-edge text-ink hover:bg-gold-line transition-colors"
                                >
                                    Lihat {method.title}
                                </Link>
                            </div>
            ...
            {/* Step by Step */}
            <div className="py-20 bg-cream px-4">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-ink mb-4">
                            Cara Kerja
                    ...
                    <div className="grid md:grid-cols-4 gap-8">
                        {steps.map((step, index) => (
                            <div key={index} className="text-center group">
                                <div className="w-16 h-16 bg-cream-deep rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-gold-line transition-colors">
                                    {step.icon}
                                </div>
            ...
            {/* Trust Section */}
            <div className="py-20 bg-ink text-cream px-4">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
                    <div className="md:w-1/2">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex gap-4">
                                <CreditCard className="w-8 h-8 text-gold flex-shrink-0" />
                                <div>
                                    <h4 className="text-lg font-bold mb-1">
                                        Transaksi Aman
                                    </h4>
                    ...
                    <div className="md:w-1/2 bg-white/5 p-8 rounded-2xl border border-white/15">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <Link
                                href={route("register")}
                                className="flex-1 py-3 bg-gold hover:bg-gold/90 text-ink text-center font-bold rounded-xl transition-colors"
                            >
                                Daftar Sekarang
                            </Link>
                            <Link
                                href={route("investments.index")}
                                className="flex-1 py-3 bg-transparent border border-white/20 hover:border-gold text-cream text-center font-bold rounded-xl transition-colors"
                            >
                                Jelajahi Properti
                            </Link>
                        </div>
